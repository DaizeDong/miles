#!/bin/bash
# Dedicated 8-node predictive R2 launcher with the post-fix stable kl-post LR multiplier.
...
#SBATCH --job-name=miles-off2-pr2-klpost1e3
#SBATCH --nodes=8
...
export RUN_POSTFIX="${RUN_POSTFIX:-off2-pr2-klpost1e3}"
