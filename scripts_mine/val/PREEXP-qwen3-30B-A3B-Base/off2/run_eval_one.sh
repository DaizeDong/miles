...
EVAL_RUNTIME_PYTHONPATH=${EVAL_RUNTIME_PYTHONPATH:-}
...
BASE_PYTHONPATH="/root/verl:/root/out-Megatron-LM"
if [ -n "${EVAL_RUNTIME_PYTHONPATH}" ]; then
  export PYTHONPATH="${BASE_PYTHONPATH}:${EVAL_RUNTIME_PYTHONPATH}${PYTHONPATH:+:${PYTHONPATH}}"
else
