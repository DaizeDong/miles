...
HF_MODEL_PATH="${HF_MODEL_PATH:-/work1/hwang/dzdong/checkpoints_hf/${MODEL_NAME}}"
REF_MODEL_PATH="${REF_MODEL_PATH:-/work1/hwang/dzdong/checkpoints_torch_dist/${MODEL_NAME}}"
DATA_CACHE_ROOT="${DATA_CACHE_ROOT:-/work1/hwang/dzdong/datasets_miles/PREEXP-${MODEL_NAME}}"
...
EXPORT_HF_FROM_MEGATRON_SCRIPT_IN_CONTAINER="${EXPORT_HF_FROM_MEGATRON_SCRIPT_IN_CONTAINER:-/root/miles/scripts_my_hpcfund/val/PREEXP-qwen3-30B-A3B-Base/off2/export_hf_from_megatron.py}"
...
CONTAINER_MOUNTS="${CONTAINER_MOUNTS:-/work1/hwang/dzdong:/work1/hwang/dzdong:rw,/work1/hwang/dzdong:/work1/hwang/dzdong:rw,/home1/dzdong/workspace/miles:/root/miles:rw,/work1/hwang/dzdong/verl:/root/verl:ro}"
