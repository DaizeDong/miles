...
AUTO_CKPT_EVAL_RUNNER_SCRIPT="$(resolve_repo_path "${AUTO_CKPT_EVAL_RUNNER_SCRIPT:-scripts_my_hpcfund/train/ckpt_auto_eval_runner_miles.sh}")"
AUTO_CKPT_EVAL_EXPORT_HF_SCRIPT="$(resolve_repo_path "${AUTO_CKPT_EVAL_EXPORT_HF_SCRIPT:-scripts_my_hpcfund/val/PREEXP-qwen3-30B-A3B-Base/off2/sbatch-export-hf.sh}")"
