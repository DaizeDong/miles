#!/bin/bash
# Verl-aligned 4-node baseline-style startup script.
#SBATCH --job-name=miles-qwen30b-4nodes
#SBATCH --nodes=4
...
export RUN_POSTFIX="${RUN_POSTFIX:-${OFF_POLICY_LABEL}-4nodes-baseline}"
###########################################
