#!/bin/bash
# Dedicated 8-node baseline launcher for off8.
# off8 means one rollout feeds eight train steps.
#SBATCH --job-name=miles-off8-baseline
#SBATCH --nodes=8
...
export RUN_POSTFIX="${RUN_POSTFIX:-off8-baseline}"
