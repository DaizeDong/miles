#!/bin/bash
# Dedicated 8-node R3 launcher for off8.
# R3 here means enabling rollout-side routing replay only.
# Actor-side routing replay and predictive replay stay disabled.
#SBATCH --job-name=miles-off8-r3
#SBATCH --nodes=8
...
BASE_SCRIPT="/home1/dzdong/workspace/miles/scripts_my_hpcfund/train/PREEXP-qwen3-30B-A3B-Base/off8/launch/hy-sbatch-8nodes.sh"
export RUN_POSTFIX="${RUN_POSTFIX:-off8-r3}"
