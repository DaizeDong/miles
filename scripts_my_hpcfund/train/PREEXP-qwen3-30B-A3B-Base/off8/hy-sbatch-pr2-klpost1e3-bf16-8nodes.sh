#!/bin/bash
# Dedicated 8-node predictive R2 launcher for off8 with bf16 predictive storage.
#SBATCH --job-name=miles-off8-pr2-klpost1e3-bf16
#SBATCH --nodes=8
...
export RUN_POSTFIX="${RUN_POSTFIX:-off8-pr2-klpost1e3-bf16}"
